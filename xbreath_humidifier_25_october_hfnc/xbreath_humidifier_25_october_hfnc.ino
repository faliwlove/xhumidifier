...
void setup()
{
  Serial.begin(38400); // atur baudrate Serial monitor di 230400
  pinmode_setup();
  analogReference(EXTERNAL);
  scheduler.setInterval(3000, send_json);
  scheduler.setInterval(1000, baca_heating_wire);
  //scheduler.setInterval(1000, print_debug_output);

  //  scheduler.setInterval(500, tampil_suhu)
  wdt_enable(WDTO_8S);
}
void loop()
{
