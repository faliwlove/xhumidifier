...
unsigned long turnOffDelay = 2500;
bool ledReady = false;
bool ledState = false;
...
void button_mode()
{
  if (kondisi_power == 1)
  {
    ...
    case 0:
      ...
      mode_suhu(suhu_merah, 27, 20);
      mode_suhu_v2(suhu_putih, 27);
      break;
    case 1:
      digitalWrite(LED_LEVEL2, LOW);
      digitalWrite(LED_LEVEL1, LOW);
      digitalWrite(LED_LEVEL3, HIGH);
      mode_suhu(suhu_merah, 32, 35);
      mode_suhu_v2(suhu_putih, 32);
      break;
    case 2:
      digitalWrite(LED_LEVEL3, LOW);
      digitalWrite(LED_LEVEL2, LOW);
      digitalWrite(LED_LEVEL1, LOW);
      mode_suhu(suhu_merah, 37, 35);
      mode_suhu_v2(suhu_putih, 37);
      break;
    }
  }
}
  ...
  if (ledReady)
  {
    ...
    if ((unsigned long)(currentMillis - buttonPushedMillis) >= turnOnDelay)
    {
      for (int i = 0; i <= 30000; i++)
      {
        ...
        {
        case 0:
          mode_suhu(suhu_putih, 27, 20);
          break;
        case 1:
          mode_suhu(suhu_putih, 32, 35);
          break;
        case 2:
          mode_suhu(suhu_putih, 37, 35);
          break;
        }
      }
      ledState = true;
